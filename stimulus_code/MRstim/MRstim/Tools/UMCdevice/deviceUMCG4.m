function [output t0] = deviceUMCG4(command,port)
...
switch(lower(command))
    ...
    case {'open','start'}
        ...
        comm('open',id.device,'9600,n,8,1');

    case {'read'}
        output = comm('read',id.device);

    case {'trigger'}
        t = comm('read',id.device);
